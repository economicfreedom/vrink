            ...
            <div class="col-sm-6 col-center">
                ...
                <div class="cart-total-box mb-5">
                    ...
                    <ul>
                        ...
                        <li><h3>가격</h3> <span>
                            <fmt:formatNumber value="${payment.totalPrice}" pattern="#,###" />
                        ...
                        <li><span id="showButton" style="cursor: pointer">구매내역 상세보기</span></li>
                        ...
                        <li class="hidden-row"><h3>가격</h3><span><fmt:formatNumber value="${paymentDetail.price}" pattern="#,###" />원</span></li>
                        </c:forEach>
