...
<li><a href="rtl.html" title="">RTL Demo<span class="badge">HOT</span></a></li>
	...
	<section class="block">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="texty-service-sec">
						<div class="row">
							<div class="col-md-3">
								<div class="texty-style">
									<i class="fa fa-forumbee"></i>
									<h3>MultiPurpose PSD</h3>
									<p>It's life. It's interesting. It's fun. If you didn't have baby clouds, you wouldn't have big clouds.</p>
								</div><!-- Texty Style -->
							</div>
							<div class="col-md-3">
								<div class="texty-style">
	...
	<section class="block">
		<div data-velocity="-.1" style="background: url(http://placehold.it/1500x1100) repeat scroll 50% 422.28px transparent;" class="parallax scrolly-invisible"></div><!-- PARALLAX BACKGROUND IMAGE -->	
			<div class="container">
				<div class="row">
					<div class="col-md-12">
								...
								<div class="contact-form">
									...
									<form>
										<div class="row">
											...
											<div class="col-md-12">
												<button type="submit" class="flat-btn">SEND NOW</button>
											</div>
										</div>
									</form>
								</div>
