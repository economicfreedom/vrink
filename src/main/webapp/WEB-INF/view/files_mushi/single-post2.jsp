					...
					<div class="row">
							...
							<div class="single-post-sec">
								<div class="blog-post">
									<div class="post-thumb">
										<img src="http://placehold.it/770x564" alt="" />
									...
									<h1>Education for There Are Many Variations Of Passages <br />These Majority  samalia</h1>
									...
									<p>Cras aliquet, nulla a feugiat adipiscing, mi enim ornare nisl, eu pellentesque nunc diam eu purus. Aliquam a arcu ac arcu aliquam vulputate ac a diam. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam aliquam massa quis mauris sollicitudin commodo venenatis ligula commodo. Sed blandit convallis dignissim. Pellentesque pharetra velit eu velit elementum et convallis erat vulputate. Sed in nulla ut elit mollis posuere.</p>
									<blockquote>
						...
						<aside class="col-md-4 column">
							...
							<div class="category_widget widget">
								...
								<ul>
									<li><a href="#" title="">Fashion</a> (56)</li>
									<li><a href="#" title="">Designing</a> (23)</li>
									<li><a href="#" title="">Web Multimedia</a> (52)</li>
									<li><a href="#" title="">Classical</a> (90)</li>
									<li><a href="#" title="">Base on line</a> (12)</li>
									<li><a href="#" title="">Music</a> (33)</li>
									<li><a href="#" title="">Graphical Lite</a> (67)</li>
									<li><a href="#" title="">Wedding</a> (26)</li>
									<li><a href="#" title="">Sunrise Shine</a> (81)</li>
									<li><a href="#" title="">Fabulous News</a> (03)</li>
								</ul>
							</div><!-- Category Widget -->
						</aside>
					</div>
					...
					<div class="comment-form">
						...
						<form>
							<div class="row">
								...
								<div class="col-md-12">
									<button type="submit" class="flat-btn">POST NOW</button>
								</div>
							</div>
						</form>
					</div><!-- Comment -->
