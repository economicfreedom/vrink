	...
	<div class="inner-head overlap">
		...
		<div class="container">
			<div class="inner-content">
				...
				<h2>BRANCH WITH SIDEBAR</h2>
				<ul>
					<li><a href="#" title="">HOME</a></li>
					<li><a href="#" title="">BRANCH WITH SIDEBAR</a></li>
				</ul>
			</div>
		</div>
	</div><!-- inner Head -->
							...
							<div class="col-md-6">
								<div class="branch">	
									<div class="branch-box">
										<img src="http://placehold.it/370x290" alt="" />
										<div class="branch-detail">
											<a title="" href="#">+</a>
											<h3><a href="#" title="">Australia Branch</a></h3>
										</div>
									</div><!-- Gallery Box -->
									<ul>
										<li>
							...
							<div class="col-md-6">
								<div class="branch">	
									<div class="branch-box">
										...
										<div class="branch-detail">
											<a title="" href="#">+</a>
											<h3><a href="#" title="">North America Branch</a></h3>
										</div>
									</div><!-- Gallery Box -->
									<ul>
										<li>
							...
							<div class="col-md-6">
								<div class="branch">	
									<div class="branch-box">
										...
										<div class="branch-detail">
											<a title="" href="#">+</a>
											<h3><a href="#" title="">United Kingdom Branch</a></h3>
										</div>
									</div><!-- Gallery Box -->
									<ul>
										<li>
							...
							<div class="col-md-6">
								<div class="branch">	
									<div class="branch-box">
										...
										<div class="branch-detail">
											<a title="" href="#">+</a>
											<h3><a href="#" title="">Netherland Branch</a></h3>
										</div>
									</div><!-- Gallery Box -->
									<ul>
										<li>
							...
							<div class="col-md-6">
								<div class="branch">	
									<div class="branch-box">
										...
										<div class="branch-detail">
											<a title="" href="#">+</a>
											<h3><a href="#" title="">Asia Branch</a></h3>
										</div>
									</div><!-- Gallery Box -->
									<ul>
										<li>
							...
							<div class="col-md-6">
								<div class="branch">	
									<div class="branch-box">
										...
										<div class="branch-detail">
											<a title="" href="#">+</a>
											<h3><a href="#" title="">Bangladesh Branch</a></h3>
										</div>
									</div><!-- Gallery Box -->
									<ul>
										<li>
