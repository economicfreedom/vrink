			...
			<div class="row">
				<div class="col-md-12">
					<div class="who-we-are-sec">
						<h3>WHO WE ARE & <span>WHAT WE DO</span></h3>
						<p>It's life. It's interesting. It's fun. If you didn't have baby clContrary to popular belief, Lorem Ipsum is not <br/> simply random text Latin literature from 45 BC, making it over 2000 years old. <br/> Richard McClintock, a Latin professor at Hampden </p>
						...
						<img src="http://placehold.it/1055x237" alt="" />
					</div><!-- Who we are -->
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="about-carousal-sec">
						<ul class="carousel">
							<li>
								<img src="http://placehold.it/568x331" alt="" />
