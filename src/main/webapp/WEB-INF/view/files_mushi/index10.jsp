...
<li><a href="rtl.html" title="">RTL Demo<span class="badge">HOT</span></a></li>
	...
	<section class="block no-padding">
		<div class="fullscreen-bg">
	        <video loop muted autoplay id="video_background" class="fullscreen-bg__video"> 
				<source src="images/resource/slider-movie.webm" type="video/webm"> 
				<source src="images/resource/slider-movie.mp4" type="video/mp4"> 
				<source src="images/resource/slider-movie.ogg" type="video/ogg"> 
			</video>	
	    </div>
	    <div class="container">
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="video-app-sec block remove-bottom text-center">
						<i class="fa fa-play-circle"></i>
						<h3>Mushi</h3>
						<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p>
						<img src="images/resource/thanks.png" alt="" />
					</div><!-- Video -->
				</div>
			</div>
		</div>
					...
					<div class="services-sec">
						<div class="row">
							<div class="col-md-6 column">
								<img src="http://placehold.it/568x697" alt="" />
							</div>
							<div class="col-md-6 column">
