			...
			<div class="row">
				<div class="col-md-12">
					<div class="about-carousal-sec">
						<ul class="carousel">
							<li>
								<img src="http://placehold.it/1051x398" alt="" />
								...
								<a href="#" title="" class="flat-btn">READ MORE</a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="col-md-12">
					<div class="team-sec">
						<div class="row">
							<div class="col-md-4">
								<div class="team-box">
									<img src="http://placehold.it/370x380" alt="" />
									<div class="team-info">
						...
						<div class="row">
							...
							<div class="col-md-5">
								<div class="ceo-message">
									<span>Manager of Creative Dep.</span>
									<h3>We are Creative Agency Our <br/>Servives is fit for you </h3>
									<p>The vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias </p>
									<a href="#" title="" class="flat-btn">MORE...</a>
								</div>
							</div>
						</div>
					</div><!-- Ceo message sec -->
