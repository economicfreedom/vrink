	...
	<div class="inner-head overlap">
		...
		<div class="container">
			<div class="inner-content">
				...
				<h2>EVENT WITH SIDEBAR</h2>
				<ul>
					<li><a href="#" title="">HOME</a></li>
					<li><a href="#" title="">EVENT WITH SIDEBAR</a></li>
				</ul>
			</div>
		</div>
	</div><!-- inner Head -->
								...
								<div class="event-single">
									<div class="event-box">
										...
										<div class="event-detail">
											<h1>Special Party in Australia</h1>
											<span>In : <a href="#" title="">AUSTRALIA</a></span>
										</div>
										<ul class="event-countdown">
									        <li>
			...
			<div class="related-posts">
				...
				<div class="related">
					<div class="row">
						<div class="col-md-4">
							<div class="event-box">
								<img alt="" src="http://placehold.it/370x313">
								<div class="event-detail">
									<h3><a title="" href="#">Special Party in Australia</a></h3>
									<span>In : <a title="" href="#">AUSTRALIA</a></span>
									<h5><i class="fa fa-location-arrow"></i>The Australian Company PVT</h5>
									<ul class="event-countdown">
								        <li>
								            <p class="days_ref">days</p>
								            <span class="days">137</span>
								        </li>
								        <li>
								        	<p class="hours_ref">hours</p>
