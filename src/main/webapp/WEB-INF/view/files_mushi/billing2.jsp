		...
		<div class="container">
			<div class="inner-content">
				...
				<ul>
					...
					<li><a href="#" title="">BILLING SIDEBAR</a></li>
				</ul>
			</div>
		</div>
	</div><!-- inner Head -->
			...
			<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="field">
									...
									<input type="text" placeholder="Add your Town / City" />
								</div>
							</div>
							<div class="col-md-6">
								<div class="field">
									...
									<select>
										<option>Choose your stats</option>
										<option>Your Stats1</option>
										<option>Your Stats1</option>
										<option>Your Stats1</option>
										<option>Your Stats1</option>
									</select>
							...
							<div class="account-create">
								...
								<div class="col-md-12">
									<div class="field">
										<textarea placeholder="Add Shipping address"></textarea>
									</div>
								</div>
							</div>
							<div class="account-create">
								...
								<div class="col-md-12">
									<div class="cart-total-box">
										...
										<ul>
											<li><h3>Shoes × 1</h3> <span>£50.00</span></li>
											<li><h3>Cart Subtotal</h3> <span>$335</span></li>
											<li><h3>Shipping</h3> <span>Free Shipping</span></li>
											<li><h3>Order Total</h3> <span>$335</span></li>
										</ul>
									</div>
								</div>
								<div class="col-md-12">
									<a href="#" title="" class="flat-btn">SUBMIT</a>
								</div>
							</div>
						</div>
					</div>
				...
				<aside class="col-md-4 column">
					...
					<div class="category_widget widget">
						...
						<ul>
							<li><a title="" href="#">Fashion</a> (56)</li>
							<li><a title="" href="#">Designing</a> (23)</li>
							<li><a title="" href="#">Web Multimedia</a> (52)</li>
							<li><a title="" href="#">Classical</a> (90)</li>
							<li><a title="" href="#">Base on line</a> (12)</li>
							<li><a title="" href="#">Music</a> (33)</li>
							<li><a title="" href="#">Graphical Lite</a> (67)</li>
							<li><a title="" href="#">Wedding</a> (26)</li>
							<li><a title="" href="#">Sunrise Shine</a> (81)</li>
							<li><a title="" href="#">Fabulous News</a> (03)</li>
						</ul>
					</div>
				</aside>
			</div>
