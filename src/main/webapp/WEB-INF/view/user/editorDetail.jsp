...
.star span {
	...
	overflow: hidden;
	pointer-events: none;
	text-shadow: -1px 0 #b67f5f, 0 1px #b67f5f, 1px 0 #b67f5f, 0 -1px
		#b67f5f;
}
</style>
<section class="block">
<div class="container">
	...
	<div class="row mb-5">
		...
		<div class="row mb-5">
			<div class="col-sm-12 t-center">${editorDetail.content}</div>
		</div>
		<div class="row mb-5">
			<div class="col-sm-2">
				<div style="display: inline-block; vertical-align: middle;">
					<span class="star"> ★★★★★ <span id="placeScore"
						style="width: 60%;">★★★★★</span> <input type="range"
						name="placeScore" id="star-val" oninput="drawStar(this)" value="6"
						step="2" min="0" max="10">
					</span>
				</div>
				<script>
							...
							<c:forEach items="${reviewList}" var="review">
								<tr class="list-tr">
									...
									<td class="t-left"><textarea rows="3" cols=""
											...
											readonly placeholder="리뷰를 입력해주세요.">${review.content}</textarea></td>
									<td>
										<div
