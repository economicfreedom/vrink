...
<div class="card m-4">
    ...
    <div class="card-header"><h3><i class="fa-solid fa-file-signature"></i> 공지사항 작성</h3></div>
            ...
            <div class="contact-form">
                <div class="editor-div">
                    <select style="width: 25%;" class="form-select mb-3" id="type">
                        <option selected value="community">자유게시판</option>
                        <option value="suggest">의뢰게시판</option>
                    </select>
                    <div>
            ...
            fetch('/admin/notice-write', {
                ...
                .then(response => {
                    if (!response.ok) {
                        ...
                        location.href = "/admin/notice?reset=1";
                    }
                })
